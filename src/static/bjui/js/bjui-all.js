...
+function ($) {
    ...
    var BJUI = {
        ...
        init: function(options) {
            ...
            $.extend(BJUI.appInfo, op.appInfo)
...
+function ($) {
    ...
    Sidenav.prototype.ajaxHnav = function() {
        ...
        BJUI.ajax('doajax', {
            ...
            loadingmask : false,
            target      : $box,
            okCallback  : function(res){options.tree ? treeCallback(res.data) : okCallback(res.data)}
        })
    }
                ...
                BJUI.ajax('doajax', {
                    ...
                    okCallback: function(response) {
                        if (dataType === 'json' || dataType === 'jsonp') {
                            tools.createTrsByData(response.data, refreshFlag)
